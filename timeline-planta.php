      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-8 text-center">
            <img class="img-fluid image-border plant-image" src="images/jiboia.jpeg" alt="">
          </div>

          <div class="col-md-4">
            <h3 class="my-3">Nome da Planta</h3>
            <p>Uma descrição da planta aqui. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam viverra
              euismod odio, gravida pellentesque urna varius vitae. Sed dui lorem, adipiscing in adipiscing et, interdum
